...
png("figura.png") ## È semplicemente una funzione di R che apre un dispositivo grafico e dice a R: “qualsiasi grafico che disegni da ora in poi, salvalo in un file PNG chiamato figura.png”.
plot(richat)
dev.off()
...
dev.off() ## devi farlo per far comparire il grafico sul dekstop
